...
def get_conversational_chain(memory):
    ...
    ------
    If the answer is not in the provided context, just say, "Answer is not available. Please contact the business directly. Thank you."
    Question: {question}
    Answer:
    """
...
def user_input(user_question, memory):
    ...
    if "Answer is not available. Please contact the business directly. Thank you." in response["output_text"]:
        final_response = "Answer is not available. Please contact the business directly. Thank you."
    else:
